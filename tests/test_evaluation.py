...
@pytest.mark.parametrize("model_name", ["seafeats", "seaclips", "resnet18"])
def test_run_evaluation_happy_case_integration(model_name, dummy_train_loader, n_classes):
    ...
    accuracy, f1_score, precision, recall = evaluator.run_evaluation(dataloader=dummy_train_loader)
